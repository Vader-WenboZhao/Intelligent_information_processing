...
#通过观察发现，点击加载更多，url变化的仅有最后的数字，每次加20，于是便可遍历
...
column=['名称','导演','演员','评分','年份','类型','电影时长','评价人数','语言','地区']
test=pd.DataFrame(columns=column,data=list_all)
test.to_csv('/Users/zhaowenbo/Downloads/crawl_ouban/test_1.csv')
# a = get_index_page(url_index)
# id_list = analysis_index_page('https://movie.douban.com/j/new_search_subjects?sort=T&range=0,10&tags=%E7%94%B5%E5%BD%B1&start=0')
